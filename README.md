...
***Comentarios:***
La estructura del proyecto es un punto de entrada con mensaje de bienvenida en App.jsx,con un footer de redes sociales y  una navbar que permite navegar
